...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/Lothbrock717/File-Sharing-Bot)</br>
...
#### Deploy in your VPS
````bash
git clone https://github.com/Lothbrock717-Sharing-Bot
cd File-Sharing-Bot
